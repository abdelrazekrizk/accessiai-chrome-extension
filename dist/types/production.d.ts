 ...
 */
import type { SystemHealthReport, SystemStatus } from './index';
...
export type ProductionEventType = 'status-changed' | 'feedback-submitted' | 'progress-started' | 'progress-updated' | 'progress-completed' | 'progress-cancelled' | 'system-alert' | 'user-action' | 'error-occurred';
...
export type ProductionErrorType = 'initialization-error' | 'runtime-error' | 'communication-error' | 'validation-error' | 'permission-error' | 'resource-error';
...
export declare const PRODUCTION_DEFAULTS: {
    readonly STATUS_DISPLAY: {
        readonly AUTO_HIDE_DELAY: 5000;
        readonly POSITION: StatusPosition;
        readonly THEME: "auto";
    };
    readonly FEEDBACK: {
        readonly MAX_ATTACHMENT_SIZE: number;
        readonly MAX_ATTACHMENTS: 3;
        readonly AUTO_INCLUDE_SYSTEM_INFO: true;
    };
    readonly PROGRESS: {
        readonly AUTO_HIDE_DELAY: 3000;
        readonly SHOW_NOTIFICATIONS: true;
        readonly SOUND_ENABLED: false;
    };
};
export declare const PRODUCTION_PERFORMANCE_TARGETS: {
    readonly STATUS_UPDATE_TIME: 50;
    readonly FEEDBACK_SUBMISSION_TIME: 500;
    readonly PROGRESS_UPDATE_TIME: 25;
    readonly UI_RESPONSE_TIME: 100;
};
